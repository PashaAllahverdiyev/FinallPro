        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Toileet = table.Column<bool>(type: "bit", nullable: false),
                    BathroomSupplies = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CityLandScare = table.Column<bool>(type: "bit", nullable: false),
                    IndoorSwimmingPoor = table.Column<bool>(type: "bit", nullable: false),
                    FreeParking = table.Column<bool>(type: "bit", nullable: false),
                    FreeWiFi = table.Column<bool>(type: "bit", nullable: false),
                    DailyHouseKeeping = table.Column<bool>(type: "bit", nullable: false),
                    SafeBox = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AirController = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Mountain = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoomLandScapes", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Hotels_HotelDetails_HotelDetailId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RoomLandScapeId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Rooms_RoomLandScapes_RoomLandScapeId",
                        column: x => x.RoomLandScapeId,
                        principalTable: "RoomLandScapes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Images_Hotels_HotellId",
                        column: x => x.HotellId,
                        principalTable: "Hotels",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RoomSizes_Rooms_RoomId",
                        column: x => x.RoomId,
                        principalTable: "Rooms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RoomSizes_Sizes_SizeId",
                        column: x => x.SizeId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Hotels_HotelDetailId",
                table: "Hotels",
                column: "HotelDetailId");

            migrationBuilder.CreateIndex(
                name: "IX_Images_HotellId",
                table: "Images",
                column: "HotellId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Rooms_RoomLandScapeId",
                table: "Rooms",
                column: "RoomLandScapeId");

            migrationBuilder.CreateIndex(
                name: "IX_RoomSizes_RoomId",
                table: "RoomSizes",
                column: "RoomId");

            migrationBuilder.CreateIndex(
                name: "IX_RoomSizes_SizeId",
                table: "RoomSizes",
                column: "SizeId");
        }
